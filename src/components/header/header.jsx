...
import MobileLogo from "../../assets/Frame1.png";

const Header = () => {
  return (
    <>
      <nav
        className="md:flex lg:flex justify-between items-center font-poppins hidden"
        style={{
          background:
      ...
      {/* // FOR MOBILE VIEW */}
      <nav className="mobile view p-3 block md:hidden">
        <div className="flex justify-between bg-white items-center">
          <div className="image">
            <img src={MobileLogo} alt="Kadima Logo" className="h-8 mr-2" />
          </div>
