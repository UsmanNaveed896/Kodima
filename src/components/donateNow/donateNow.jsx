  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-12 grid-cols-1 items-center md:p-0 p-6">
            ...
            <div>
              ...
              <div className=" mt-8">
                <div className="flex gap-2 justify-center flex-wrap">
                  <div data-aos="zoom-in"  className="bg-white rounded-xl w-[150px] h-[200px] flex flex-col items-center justify-center">
                ...
                <div data-aos="zoom-in" className="flex items-center justify-center bg-white border border-gray-300 rounded-lg px-4 py-2 w-full mt-5 ">
                  {/* Currency Symbol */}
        ...
        <div  data-aos="fade-left" className="col-span-3 col-span-3 md:block hidden">
